...
Or in another example, copies of a smaller data set are distributed across computers to perform different computations on it, and when all the individual anaylises of the data are finished, the results are summarized. 
...
In [Module 7][ModDoc7], we will discuss how to set up and access a virtual machine. Using software like *MapReduce* is not part of this tutorial.
