...
{% img src=images/CloudServices.png, w=80, dim=percent, alt=image, align=center %}
{% col 255,0,0 %} 
...
{% img src=images/CloudServices2.png, w=80, dim=percent, alt=image, align=center %}
{% col 255,0,0 %} 
TODO: Make an image of this draft
{% endcol %}
...
{% img src=images/CloudServices3.png, w=80, dim=percent, alt=image, align=center %}
{% col 255,0,0 %} 
TODO: Make an image of this draft
{% endcol %}
