...
{% img src=images/passwordStrength.png, w=50, dim=percent, align=center, alt=, css=margin-top:20px;margin-bottom:20px; %}
...
{% img src=images/PortCommunications.png, w=80, dim=percent, alt=, align=center %}
...
{% img src=images/SSHKeys.png, w=80, dim=percent, alt=, align=center %}
...
{% img src=images/SSHTunnel.png, w=70, dim=percent, align=center, alt=, css=margin-top:20px; margin-bottom: 20px; %}
