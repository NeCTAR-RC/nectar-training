...
{% img src=images/dashboardLogin.png, w=60, dim=percent, align=center, alt=, css=margin-top:20px; margin-bottom:20px; %}  
...
{% img src=images/dashboardLogin2.png, w=60, dim=percent, align=center, alt=, css=margin-top:20px; margin-bottom:20px; %}  
...
{% img src=images/dashboard.png, w=60, dim=percent, align=center, alt=, css=margin-top:20px; margin-bottom:20px; %}  
...
{% img src=images/scrTerminalOnRemoteDesktop.png, w=60, dim=percent, alt=, align=center %}
...
{% img src=images/dashboardUtilization.png, w=70, dim=percent, align=center, alt=, css=margin-top:20px; margin-bottom:20px; %}  
